...
${formData.message.trim()}`;
  ...
  return (
    <section id="contact" className="py-20 md:py-28 relative bg-[#050505]">
      {/* Background glow */}
      <div className="absolute -bottom-10 right-1/4 w-[600px] h-[600px] bg-amber-500/10 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Quick WhatsApp Card */}
            <div className="bg-zinc-900 rounded-3xl p-6 border border-white/10 hover:border-emerald-500/40 transition-all shadow-xl group">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-2xl bg-black border border-white/10 flex items-center justify-center text-emerald-400 group-hover:scale-105 group-hover:border-emerald-500/40 transition-transform">
                  <MessageSquare className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-lg font-heading font-bold text-white">واتساب مباشر</h3>
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs transition-all shadow-lg shadow-emerald-950/40 cursor-pointer"
              >
            ...
            {/* Direct Phone Call */}
            <div className="bg-zinc-900 rounded-3xl p-6 border border-white/10 hover:border-amber-500/40 transition-all shadow-xl group">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-2xl bg-black border border-white/10 flex items-center justify-center text-amber-500 group-hover:scale-105 group-hover:border-amber-500/40 transition-transform">
                  <Phone className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-lg font-heading font-bold text-white">الاتصال الهاتفي المباشر</h3>
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-lg bg-black hover:bg-zinc-850 border border-white/10 hover:border-amber-500/40 text-white font-bold text-xs transition-all cursor-pointer"
              >
            ...
            <div className="bg-zinc-900 rounded-3xl p-6 border border-white/10 space-y-4 shadow-xl">
          ...
          <div className="lg:col-span-7">
            <div className="bg-zinc-900 rounded-3xl p-8 border border-white/10 relative shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-5" id="direct-contact-form">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black border border-white/10 rounded-lg px-4 py-3 text-xs text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-amber-500 transition-colors"
                    />
                  </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-black border border-white/10 rounded-lg px-4 py-3 text-xs text-zinc-200 focus:outline-none focus:border-amber-500 transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-black border border-white/10 rounded-lg p-4 text-xs text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-amber-500 transition-colors resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-lg text-sm font-bold bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-950/40 transition-all duration-200 flex items-center justify-center gap-2.5 cursor-pointer active:scale-[0.99]"
                >
                  <MessageSquare className="w-4 h-4" />
                ...
                {submitted && (
                  <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs flex items-center gap-2.5 animate-fadeIn">
