...
export const HeadphonesSection: React.FC = () => {
  return (
    <section id="headphones" className="py-20 md:py-28 relative bg-black border-b border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-zinc-900 rounded-3xl p-8 border border-white/10 hover:border-amber-500/40 transition-all duration-300 group shadow-xl">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 rounded-2xl bg-black border border-white/10 flex items-center justify-center text-amber-500 group-hover:scale-105 group-hover:border-amber-500/50 transition-transform">
                <Radio className="w-7 h-7" />
              </div>
              <div>
                <h3 className="text-2xl font-heading font-bold text-white">السماعات اللاسلكية</h3>
          ...
          <div className="bg-zinc-900 rounded-3xl p-8 border border-white/10 hover:border-amber-500/40 transition-all duration-300 group shadow-xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-heading font-bold text-white">السماعات السلكية</h3>
