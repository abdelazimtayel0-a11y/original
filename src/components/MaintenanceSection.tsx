...
${customNotes ? `• تفاصيل العطل: ${customNotes}` : ''}`;
  ...
  return (
    <section id="maintenance" className="py-20 md:py-28 relative">
      {/* Background ambient lighting */}
      <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-amber-500/5 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {MAINTENANCE_SERVICES.map((service, idx) => (
            <div
              key={idx}
              className="bg-zinc-900 hover:bg-zinc-850 rounded-2xl p-6 border border-white/10 hover:border-amber-500/40 transition-all duration-300 group shadow-lg"
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-black border border-white/10 flex items-center justify-center text-amber-500 group-hover:scale-105 group-hover:border-amber-500/50 transition-transform">
                  <CheckCircle2 className="w-5 h-5" />
                </div>
                <h3 className="text-lg font-heading font-bold text-white group-hover:text-amber-500 transition-colors">
                  {service.title}
                </h3>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-zinc-900 rounded-3xl p-8 border border-white/10 shadow-xl">
              <h3 className="text-2xl font-heading font-bold text-white mb-6 flex items-center gap-2.5">
              ...
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  <div className="w-9 h-9 rounded-xl bg-black text-amber-500 flex items-center justify-center font-bold text-sm flex-shrink-0 border border-amber-500/40">
                    1
                  </div>
                  <div>
                    <h4 className="text-base font-bold text-white mb-1">استلام الجهاز وفحص دقيق للأعطال</h4>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-white mb-1">استخدام قطع الغيار الأصلية المعتمدة</h4>
                    <p className="text-xs text-zinc-400 leading-relaxed">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-white mb-1">اختبار الجودة والأداء قبل التسليم</h4>
                    <p className="text-xs text-zinc-400 leading-relaxed">
              ...
              <div className="mt-8 pt-6 border-t border-white/10 grid grid-cols-3 gap-3 text-center">
                <div className="p-3 rounded-xl bg-black/40 border border-white/5">
                  ...
                  <span className="text-[11px] text-zinc-300 font-semibold block">صيانة سريعة</span>
                </div>
                <div className="p-3 rounded-xl bg-black/40 border border-white/5">
                  <UserCheck className="w-5 h-5 mx-auto text-amber-500 mb-1" />
                  <span className="text-[11px] text-zinc-300 font-semibold block">فنيون معتمدون</span>
                </div>
                <div className="p-3 rounded-xl bg-black/40 border border-white/5">
                  <ShieldCheck className="w-5 h-5 mx-auto text-amber-500 mb-1" />
                  <span className="text-[11px] text-zinc-300 font-semibold block">ضمان الجودة</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-zinc-900 rounded-3xl p-7 border border-white/10 shadow-2xl relative">
              ...
              <form onSubmit={handleSubmitInquiry} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`py-2.5 px-4 rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer border ${
                        deviceType === 'iPhone'
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-black border border-white/10 rounded-lg px-4 py-2.5 text-xs text-zinc-200 focus:outline-none focus:border-amber-500 transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-black border border-white/10 rounded-lg p-3 text-xs text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-amber-500 transition-colors resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 px-4 rounded-lg text-sm font-bold bg-emerald-600 text-white hover:bg-emerald-500 shadow-lg shadow-emerald-950/40 transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]"
                >
