...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-gradient-to-br from-black via-zinc-900/60 to-black border-b border-white/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-right space-y-6">
            ...
            <div className="flex flex-wrap gap-2.5 justify-center lg:justify-start pt-1">
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-zinc-900 border border-white/10 text-xs text-zinc-300 font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-lg text-base font-bold bg-amber-500 text-white hover:bg-amber-600 transition-all shadow-lg shadow-amber-500/20 active:scale-[0.98] cursor-pointer text-center"
              >
                استكشف خدماتنا
              </button>
              ...
              <button
                ...
                className="w-full sm:w-auto border border-white/20 px-8 py-3.5 rounded-lg text-base font-bold hover:bg-white/10 text-white transition-all cursor-pointer text-center"
              >
                تواصل معنا
              </button>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative group w-full max-w-md flex justify-center">
              ...
              <div className="absolute inset-0 bg-amber-500 blur-[80px] opacity-20 group-hover:opacity-30 transition-opacity pointer-events-none" />
              
              {/* Main Card */}
              <div className="relative rounded-3xl bg-zinc-900 border border-white/10 p-6 shadow-2xl backdrop-blur-xl transition-all duration-500">
                
                {/* Official Logo Showcase */}
                <div className="relative rounded-2xl overflow-hidden bg-black p-4 border border-white/10 shadow-inner group">
                  <div className="aspect-square w-full max-w-[280px] mx-auto rounded-xl overflow-hidden border border-white/10 flex items-center justify-center bg-black">
                    <img
                      src={LOGO_URL}
                  ...
                  {/* Badge on Logo */}
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 px-4 py-1.5 rounded-full bg-black/90 border border-amber-500/50 text-amber-500 text-xs font-bold tracking-widest backdrop-blur-md shadow-lg flex items-center gap-1.5 uppercase">
                ...
                {/* Services Bar */}
                <div className="mt-6 grid grid-cols-4 gap-2 pt-4 border-t border-white/10 text-center">
                  <div className="p-2 rounded-xl bg-black/50 border border-white/5 hover:border-amber-500/40 transition-colors">
                    <Wrench className="w-5 h-5 mx-auto text-amber-500 mb-1" />
                    <span className="text-[11px] text-zinc-300 font-medium block">صيانة</span>
                  </div>
                  <div className="p-2 rounded-xl bg-black/50 border border-white/5 hover:border-amber-500/40 transition-colors">
                    <Sparkles className="w-5 h-5 mx-auto text-amber-500 mb-1" />
                    <span className="text-[11px] text-zinc-300 font-medium block">قطع أصلية</span>
                  </div>
                  <div className="p-2 rounded-xl bg-black/50 border border-white/5 hover:border-amber-500/40 transition-colors">
                    <Headphones className="w-5 h-5 mx-auto text-amber-500 mb-1" />
                    <span className="text-[11px] text-zinc-300 font-medium block">سماعات</span>
                  </div>
                  <div className="p-2 rounded-xl bg-black/50 border border-white/5 hover:border-amber-500/40 transition-colors">
                    <Watch className="w-5 h-5 mx-auto text-amber-500 mb-1" />
                    <span className="text-[11px] text-zinc-300 font-medium block">ساعات</span>
                  </div>
                </div>

                {/* Trust Seal */}
                <div className="mt-4 flex items-center justify-between px-4 py-2.5 rounded-xl bg-black/60 border border-white/10 text-xs">
