...
export const SmartwatchesSection: React.FC = () => {
  return (
    <section id="smartwatches" className="py-14 sm:py-20 md:py-28 relative bg-black border-b border-white/10 overflow-hidden">
      {/* Ambient glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] sm:w-[500px] lg:w-[700px] h-[300px] sm:h-[400px] lg:h-[500px] bg-gradient-to-r from-amber-500/10 via-amber-400/5 to-transparent rounded-full blur-[90px] sm:blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 space-y-3 sm:space-y-4">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1 sm:py-1.5 border border-amber-500/50 rounded-full text-[11px] sm:text-xs text-amber-500 font-bold uppercase tracking-wider sm:tracking-widest bg-amber-500/5">
            <Watch className="w-3.5 h-3.5 text-amber-500 flex-shrink-0" />
        ...
        <div className="bg-zinc-900 rounded-2xl sm:rounded-3xl p-5 sm:p-8 lg:p-12 border border-white/10 shadow-2xl relative mb-10 sm:mb-14 hover:border-amber-500/30 transition-all duration-300">
          
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
            
            {/* Left Column: Smart Capabilities */}
            <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-right">
              <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1 rounded-full bg-black border border-white/10 text-xs text-amber-500 font-semibold">
                <Sparkles className="w-3.5 h-3.5 text-amber-500 flex-shrink-0" />
                <span>فخامة التصميم + دقة الأداء</span>
              </div>

              <h3 className="text-xl sm:text-2xl lg:text-3xl font-heading font-black text-white leading-snug">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 pt-2">
                <div className="p-2.5 sm:p-3 rounded-xl bg-black border border-white/10 flex items-center gap-2 sm:gap-2.5">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-black border border-white/10 text-center w-full max-w-sm shadow-xl">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-zinc-900 border border-amber-500/30 flex items-center justify-center text-amber-500 mx-auto mb-3 sm:mb-4 shadow-lg shadow-amber-500/10">
                  <Watch className="w-8 h-8 sm:w-10 sm:h-10" />
                </div>
                
                <h4 className="text-lg sm:text-xl font-heading font-black text-white mb-2">
                  ساعات Smart أصلية
                </h4>
                ...
                <div className="p-2.5 sm:p-3 rounded-xl bg-amber-500/10 border border-amber-500/30 text-xs font-bold text-amber-500 tracking-wide">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {SMARTWATCH_HIGHLIGHTS.map((item, idx) => (
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-black border border-white/10 flex items-center justify-center text-amber-500 mb-3 sm:mb-4 font-bold text-xs group-hover:border-amber-500/40">
                0{idx + 1}
              </div>
