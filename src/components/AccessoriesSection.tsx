...
export const AccessoriesSection: React.FC = () => {
  return (
    <section id="accessories" className="py-14 sm:py-20 md:py-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 space-y-3 sm:space-y-4">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1 sm:py-1.5 border border-amber-500/50 rounded-full text-[11px] sm:text-xs text-amber-500 font-bold uppercase tracking-wider sm:tracking-widest bg-amber-500/5">
            <Smartphone className="w-3.5 h-3.5 text-amber-500 flex-shrink-0" />
          ...
          {ACCESSORIES_CATEGORIES.map((item, idx) => {
            ...
            return (
              <div
                ...
                className="bg-zinc-900 hover:bg-zinc-850 border border-white/10 hover:border-amber-500/40 rounded-2xl sm:rounded-3xl p-5 sm:p-7 flex flex-col justify-between relative group overflow-hidden transition-all duration-300 shadow-xl"
              >
                {/* Prestige Corner Number */}
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-xl bg-black border border-white/10 flex items-center justify-center text-amber-500 group-hover:scale-105 group-hover:border-amber-500/50 transition-all duration-300">
                    <Icon className="w-5 h-5 sm:w-6 sm:h-6" />
                  </div>
                  <span className="text-amber-500 text-xl sm:text-2xl font-bold font-mono opacity-30 group-hover:opacity-100 transition-opacity">
                    {num}
                  </span>
                </div>
                ...
                <div>
                  {/* Title */}
                  <h3 className="text-lg sm:text-xl font-heading font-bold text-white mb-2 sm:mb-3 group-hover:text-amber-500 transition-colors">
                    {item.title}
                  </h3>
                ...
                {/* Features list */}
                <div className="pt-4 border-t border-white/10 space-y-2 sm:space-y-2.5">
        ...
        {/* Brand statement box */}
        <div className="mt-8 sm:mt-12 rounded-2xl bg-zinc-900 border border-white/10 p-5 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
